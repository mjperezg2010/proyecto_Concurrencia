archivo=open("Dataset_Limpio_1.txt","r")
...
listaPreposiciones=["about", "above", "across", "after", "against", "along", "among", "around", "at",
  ...
  "like", "near", "of", "off", "onto", "out", "outside", "over", "past", "regarding",
  "since", "through", "throughout", "to", "toward", "under", "underneath", "until", "up",
  "upon", "up to", "with", "within", "without", "with regard to", "with respect to","and","the","my"]
